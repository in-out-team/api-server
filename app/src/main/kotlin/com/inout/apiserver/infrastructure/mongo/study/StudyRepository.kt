...
interface StudyRepositoryInternal : MongoRepository<Study, ObjectId> {
...
class StudyRepository(
    private val studyRepositoryInternal: StudyRepositoryInternal,
    private val mongoTemplate: MongoTemplate,
) : StudyRepositoryInternal by studyRepositoryInternal {
    fun findAllPastDueStudiesBy(
        ...
        if (excludeIds.isEmpty()) {
            studyRepositoryInternal.findAllByUserIdAndDueLessThanOrderByDue(
                userId = userId,
                due = due,
                pageable = pageable,
            )
        } else {
            studyRepositoryInternal.findAllByUserIdAndDueLessThanAndIdNotInOrderByDue(
                userId = userId,
                due = due,
    ...
    fun findAllByUserIdAndWordNamePrefix(
        ...
        val results =
            mongoTemplate
                .aggregate(aggregation, "studies", Study::class.java)
                .mappedResults
